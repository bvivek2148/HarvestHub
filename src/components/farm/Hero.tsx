...
const ROLE_CARDS = [
  {
    ...
    color: 'var(--fd-green)',
    bg: 'var(--fd-green-bg)',
    border: 'color-mix(in srgb, var(--fd-green), transparent 70%)',
  ...
  },
  {
    ...
    color: 'var(--fd-gold)',
    bg: 'var(--fd-gold-bg)',
    border: 'color-mix(in srgb, var(--fd-gold), transparent 70%)',
    badge: 'BUYER',
    stat: '18K+ orders',
  },
  {
    ...
    color: 'var(--fd-purple)',
    bg: 'var(--fd-purple-bg)',
    border: 'color-mix(in srgb, var(--fd-purple), transparent 70%)',
    badge: 'ADMIN',
    stat: 'Platform-wide',
  },
]
